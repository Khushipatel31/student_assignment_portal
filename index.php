	...
	<main class="main-container">
		...
		<div class="box-container ps-5 pe-5">
			<div class="row margin">
				...
				<div onclick="window.open('/batches','_self')" class="col-md-3 m-1 box dashboard-tile">
					<!-- <i class="fa-regular fa-building"></i> -->
					<div class="dashboard-tile-header h4">Batches</div>
				</div>
				<div class="col-md-1 extraBox"></div>
				<div onclick="window.open('/students','_self')" class="col-md-3 m-1 box dashboard-tile">
					<!-- <i class="fa-regular fa-building"></i> -->
			...
			<div class="row margin">
				...
				<div onclick="window.open('/assignments','_self')" class="col-md-3 m-1 box">
					<!-- <i class="fa-regular fa-building"></i> -->
